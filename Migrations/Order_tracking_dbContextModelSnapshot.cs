...
{
    [DbContext(typeof(Order_tracking_dbContext))]
    partial class Order_tracking_dbContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("Courier_Service_part_1.Model.OrderClass", b =>
                {
                    ...
                    b.HasOne("Courier_Service_part_1.Model.Order_track_Class", "order_Track")
                        .WithOne()
                        .HasForeignKey("Courier_Service_part_1.Model.OrderClass", "order_track_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Courier_Service_part_1.Model.Order_track_Class", b =>
                {
                    b.HasOne("Courier_Service_part_1.Model.ReciverClass", "reciver")
                        .WithOne()
                        .HasForeignKey("Courier_Service_part_1.Model.Order_track_Class", "reciver_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Courier_Service_part_1.Model.SenderClass", "sender")
                        .WithOne()
                        .HasForeignKey("Courier_Service_part_1.Model.Order_track_Class", "sender_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
